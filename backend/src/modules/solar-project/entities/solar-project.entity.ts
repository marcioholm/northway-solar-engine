...
export class SolarProject {
  ...
  @Column({
    name: 'pricing_effective_margin_pct',
    type: 'float',
    nullable: true,
  })
  ...
  @Column({
    name: 'pricing_recommended_margin_pct',
    type: 'float',
    nullable: true,
  })
