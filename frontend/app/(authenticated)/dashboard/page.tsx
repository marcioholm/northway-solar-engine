...
export default function Dashboard() {
  return (
    <Suspense fallback={<div style={{ color: 'var(--text-secondary)', padding: '32px' }}>Carregando...</div>}>
      <DashboardContent />
    </Suspense>
  );
}
  ...
  const handleGeneratePdf = async () => {
    ...
    try {
      ...
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/proposals`, {
        ...
        body: JSON.stringify({
          consumption, city: `${selectedCity} - ${selectedState}`,
          clientName: clientName || 'Cliente Visitante', clientCep: '00000-000',
    ...
    <div style={{ maxWidth: '1440px', padding: '32px 36px', background: 'var(--bg)' }}>
      <Stack gap={8}>
        <PageHeader
          ...
          subtitle="Configure os parâmetros técnicos para gerar uma proposta."
          actions={result && <Button variant="secondary" size="sm">Histórico</Button>}
        />
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: '24px', alignItems: 'start' }}>
            ...
            <Card padding="lg">
              ...
              <form onSubmit={handleCalculate} style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px' }}>
                ...
                <Input
                  ...
                  options={[{ label: 'Selecione...', value: '' }, ...states.map(s => ({ label: s.nome, value: s.sigla }))]}
                  required
                />
                <Input
                  label="Cidade"
                ...
                />
                <div style={{ gridColumn: 'span 3' }}>
                  <Button type="submit" loading={loading} size="md" style={{ padding: '12px 28px' }}>
                    Calcular Proposta
                  </Button>
            ...
            {result && (
              <>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' }}>
                  <Card padding="md">
                    ...
                    <Text variant="h1" style={{ fontSize: '28px', marginTop: '4px' }}>
                      ...
                      <Text variant="body" color="secondary" as="span">kWp</Text>
                    </Text>
                  </Card>
                  <Card padding="md">
                    ...
                    <Text variant="h1" style={{ fontSize: '28px', marginTop: '4px' }}>
                      ...
                      <Text variant="body" color="secondary" as="span">kWh</Text>
                    </Text>
                  </Card>
                  <Card padding="md">
                    <Text variant="xxs" color="secondary">Inversor</Text>
                    <Text variant="h4" style={{ marginTop: '4px' }}>{result.inverter.model}</Text>
                    <Text variant="xs" color="accent" style={{ marginTop: '2px', fontWeight: 600 }}>
                ...
                <div style={{
                  ...
                  background: 'var(--surface-muted)', padding: '16px 20px',
                  borderRadius: 'var(--radius-lg)',
                  border: '1px dashed var(--border)', gap: '16px',
                }}>
                  <div>
                  ...
                  <span style={{
                    ...
                    background: '#EEF2ED', color: '#58605A',
          ...
          {result ? (
            <div style={{
              ...
              borderRadius: 'var(--radius-xl)', padding: '32px', color: '#fff',
              boxShadow: 'var(--shadow-glow)', position: 'sticky', top: '24px',
            }}>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '4px', marginTop: '4px' }}>
                <span style={{ fontSize: '20px', fontWeight: 600, marginTop: '4px' }}>R$</span>
                <span style={{ fontSize: '44px', fontWeight: 900, letterSpacing: '-0.02em', lineHeight: 1 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                ...
                <div>
                  ...
                  <Text variant="h2" style={{ color: '#fff' }}>
                    ...
                    <Text variant="body" as="span" style={{ opacity: 0.7, color: '#fff' }}>Anos</Text>
                  </Text>
                </div>
              </div>
              ...
              <Text variant="xs" style={{ textAlign: 'center', marginTop: '16px', opacity: 0.5, color: '#fff' }}>
            ...
            <div style={{
              ...
              padding: '48px 24px', color: 'var(--text-muted)', gap: '8px',
