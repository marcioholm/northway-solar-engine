...
export function TimelineSteps({ data }: { data: ProposalData }) {
  ...
  return (
    <SectionWrapper level="content" background="var(--bg)" className="print-break-before">
      <div style={{ textAlign: 'center', marginBottom: 40 }}>
        <h2 style={{ fontSize: 'clamp(24px, 2.5vw + 14px, 42px)', fontWeight: 700, letterSpacing: '-0.02em', margin: '0 0 16px', color: 'var(--text)' }}>Etapas Previstas</h2>
        <p style={{ fontSize: '13px', color: 'var(--text-secondary)', lineHeight: 1.6, maxWidth: 600, margin: '0 auto' }}>
