  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
      <div style={{ padding: '48px 24px', textAlign: 'center', background: 'var(--ws-surface-raised)', borderRadius: 'var(--ws-radius-lg)', border: '1px dashed var(--ws-border)' }}>
        ...
        <p style={{ margin: 0, fontSize: 14, color: 'var(--ws-text-secondary)' }}>Nenhum documento anexado</p>
        <p style={{ margin: '4px 0 0', fontSize: 12, color: 'var(--ws-text-muted)' }}>Adicione ART, contratos, manuais e fotos do projeto.</p>
        <div style={{ display: 'flex', justifyContent: 'center', gap: 8, marginTop: 16 }}>
          <button style={{ padding: '8px 16px', borderRadius: 8, border: '1px solid var(--ws-border)', background: 'var(--ws-surface)', color: 'var(--ws-text)', fontSize: 12, fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit', display: 'flex', alignItems: 'center', gap: 6 }}>
